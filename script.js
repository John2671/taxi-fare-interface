// let taxiFareApiUrl = 'https://taxifare-john-uiovyej6ca-ew.a.run.app/predict'; // replace with your API endpoint
let taxiFareApiUrl = 'https://taxifare-sebadq-o3ef2cg24q-ew.a.run.app/predict'; // replace with your API endpoint
